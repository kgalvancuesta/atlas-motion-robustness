...
def _training_expected(definition: dict[str, Any], *, model: str, regime: str, fold: int) -> dict[str, Any]:
    ...
    return {
        ...
        "early_stopping_patience": int(definition["configuration"]["early_stopping_patience"]),
    ...
    *,
    ...
    command = [
        ...
        *[str(value) for value in config["patch_size"]],
        ...
        "--pin_memory",
        "--val_interval",
        str(definition["configuration"]["validation_interval"]),
        "--patience",
        str(definition["configuration"]["early_stopping_patience"]),
        "--seed",
